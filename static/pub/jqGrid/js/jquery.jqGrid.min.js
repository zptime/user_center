...
window,Pa=Oa?"orientationchange":"resize";$(window).on(Pa,function(){$(d).jqGrid("resizeGrid")})}}})},$.jgrid.extend({getGridAttr:function(a,b){var k=null;if(a&&a=='istypeAll'){var t=$('.jqgh_'+$(this).attr('id')+'_multi_type_select').val();if(t=='2')return true;};return false},getGridParam:function(a,b){var
